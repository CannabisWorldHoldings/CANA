...
| 23 | Cost control | PARTIAL | `packages/paid-governance/` (`48031962e600eadcf170365e177ee14f09169913`); legacy daily cap in `.cana-governor-v3` | Governance tests; no verified Gemini grant ledger | Billing-export reconciliation and owner-confirmed grant balance |
