...
| 23 | Cost control | PARTIAL | `packages/paid-governance/` (`48031962e600eadcf170365e177ee14f09169913`); signed call-time receipt verification in `packages/ad-creative/src/paid-authorization.mjs`; legacy daily cap in `.cana-governor-v3` | Governance tests plus request-bound signature, expiry and reserved-cost tests; no verified Gemini grant ledger | Paid-governance receipt issuance, billing-export reconciliation and owner-confirmed grant balance |
