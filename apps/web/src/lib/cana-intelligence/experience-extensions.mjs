...
export function createExperienceCandidate({objective,target,operations,manifestBefore=null,proposer,evidenceReceiptDigests=[],experimentId=null,merchantId=null,tenantId=null}){
  ...
  const c={candidateId:newId('experience'),objective,target,operations,manifestBefore,proposer,evidenceReceiptDigests,experimentId,merchantId,tenantId,status:'CANDIDATE_ONLY',blastRadius:blast,authorityRequired:merchantId&&tenantId?'OWNER_AND_MERCHANT':blast==='LOW'?'OWNER_OR_DELEGATED':'OWNER',mayExecute:false,mayPublish:false,createdAt:new Date().toISOString()};
