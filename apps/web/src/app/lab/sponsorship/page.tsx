...
type LedgerEntryOverride = Record<string, unknown>;

const issue = (o: LedgerEntryOverride = {}) => ({ merchantId: M, kind: 'ISSUE', seq: 0, amount: 500, authorizationRef: 'PO-1', expiresAt: future, prevHash: 'genesis', entryHash: 'h0', ...o });
const spend = (o: LedgerEntryOverride = {}) => ({ merchantId: M, kind: 'SPEND', seq: 1, amount: -100, placement: 'FEATURED_CARD', disclosureLabel: 'Sponsored placement', affectsOrganicOrder: false, prevHash: 'h0', entryHash: 'h1', ...o });
const refund = (o: LedgerEntryOverride = {}) => ({ merchantId: M, kind: 'REFUND', seq: 2, amount: 100, originalSeq: 1, reason: 'under-delivered', prevHash: 'h1', entryHash: 'h2', ...o });

const SCENARIOS: Array<{ id: string; title: string; note: string; entries: Array<Record<string, unknown>>; opts?: Record<string, unknown> }> = [
